...
::: {.column width="40%"}
::: {.fragment fragment-index=1}
![](images/palmerpenguins.png){width=45% fig-align="center"}

![Artwork by @allison_horst](images/culmen_depth.png){width=80% fig-align="center"}
:::
:::
...
::: {.content-visible when-meta="long-version"}
...
## Using `{assertr}` for data checking {auto-animate=true}
...
- Are all flipper length values positive (after removing `NA`s)?
:::
...
::: {.fragment}
::: {.callout-note}
More on data checking in Danielle Navarro's blog post on [Four ways to write assertion checks in R](https://blog.djnavarro.net/posts/2023-08-08_being-assertive/).
:::
:::
...
::: {.column width="45%"}
\ 
![](images/word_report.png){width=85% fig-align="center"}
:::
...
## Writing a report -- Quarto + `{targets}` {auto-animate=true}

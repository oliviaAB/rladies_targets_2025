...
```{r tar-visnetwork-up-to-date}
targets::tar_visnetwork()
```


![](images/tar_visnetwork_all_up_to_date.png){width=60% fig-align="center"}

## After executing the pipeline

```{r tar-make-up-to-date}
targets::tar_make()
```

```{r tar-make-results-up-to-date}
#| echo: false
#| eval: true
#| message: true
...
v skipped target bill_scatterplot
v skipped target flipper_length_plot
v skipped pipeline [0.1 seconds]
")
```
...
- The [targets user manual](https://books.ropensci.org/targets/)

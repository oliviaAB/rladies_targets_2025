...
![<https://books.ropensci.org/targets/>](images/targets_manual_coloured.png)
...
![](images/previous_talk_content_coloured.png){fig-align="center" width=60%}
...
::: {.column width="45%"}
\ 
![](images/word_report_coloured.png){width=100% fig-align="center"}
:::
